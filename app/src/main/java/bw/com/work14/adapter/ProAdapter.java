...
public class ProAdapter extends XRecyclerView.Adapter<ProAdapter.ViewHolder> {
    private Context context;
    private List<SerchBean.ResultBean> list;

    public ProAdapter(Context context, List<SerchBean.ResultBean> list) {
